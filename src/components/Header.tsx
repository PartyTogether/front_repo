                    ...
                    {isDropdownOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-50">
                            ...
                            <button
                                ...
                                className="block w-full text-left px-4 py-2 text-m text-gray-700 hover:bg-gray-100"
                            >
                                로그아웃
                            </button>
                        </div>
    ...
    return (
        <header className="fixed top-0 left-0 w-full h-16 bg-white shadow-md flex items-center justify-between px-4 md:px-6 z-50">
            ...
            <div className="flex items-center gap-10">
                <nav className="hidden md:flex gap-4 text-gray-800 font-semibold">
                    <Link
                        href="/"
                        className={`flex items-center gap-2 transform text-base transition duration-200 hover:scale-110 px-4 py-2 rounded-full ${
                            pathname === "/"
